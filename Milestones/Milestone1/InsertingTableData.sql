...
INSERT INTO employees(id,emp_code,fullName,gender,birthDate,designation,joiningDate,salary,deptId,nationality,isHead)
VALUES
(1, 'EMP001', 'John Smith', 'Male', '1990-05-15', 'Manager', '2010-07-01', 50000.00, 101, 'American',''),
    ...
    (3, 'EMP003', 'Michael Brown', 'Male', '1985-09-08', 'Senior Analyst', '2018-04-05', 45000.00, 103, 'Canadian',1),
    (4, 'EMP004', 'Emily Davis', 'Female', '1988-03-25', 'HR Manager', '2017-08-20', 48000.00, 104, 'Australian',''),
    (5, 'EMP005', 'David Wilson', 'Male', '1993-06-30', 'Software Developer', '2019-01-15', 42000.00, 102, 'American',1),
    ...
    (8, 'EMP008', 'Jennifer Lee', 'Female', '1990-08-05', 'Project Manager', '2013-12-03', 52000.00, 104, 'American',1),
